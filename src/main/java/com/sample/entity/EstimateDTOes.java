...
public class EstimateDTOes {
    ...
    public EstimateDTOes(Long id, String ordertype, String customerdisplayname_id, String status_id, String createddate,
			String total, String memoonstatement) {
