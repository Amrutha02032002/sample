...
public class CustservicessDTO {
    ...
    private List<ConnectiondetailsDTO> connectiondetails;
    ...
    public List<ConnectiondetailsDTO> getConnectiondetails() {
        return connectiondetails;
    }
    public void setConnectiondetails(List<ConnectiondetailsDTO> connectiondetails) {
