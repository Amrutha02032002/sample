...
public class Estimate {
   ...
   private String notetocustomer;
    ...
    private List<Estimateproductdetails> estimateProductDetails;
    
    @OneToMany(mappedBy = "estimate", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<Estimatewithouttax> estimateWithoutTax;
    ...
    @OneToMany(mappedBy = "estimate", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<Emailestimate> emailEstimates; 
	...
	public List<Estimateproductdetails> getEstimateProductDetails() {
		return estimateProductDetails;
	}



	public void setEstimateProductDetails(List<Estimateproductdetails> estimateProductDetails) {
	...
	public List<Emailestimate> getEmailEstimates() {
		return emailEstimates;
	}



	public void setEmailEstimates(List<Emailestimate> emailEstimates) {
		this.emailEstimates = emailEstimates;
	}



	public List<Estimatewithouttax> getEstimateWithoutTax() {
		return estimateWithoutTax;
	}



	public void setEstimateWithoutTax(List<Estimatewithouttax> estimateWithoutTax) {
