...
public class CustservicessResponseDTO {
    ...
    private List<ConnectiondetailsResponseDTO> connectiondetails;
	...
	public List<ConnectiondetailsResponseDTO> getConnectiondetails() {
		return connectiondetails;
	}
	public void setConnectiondetails(List<ConnectiondetailsResponseDTO> connectiondetails) {
