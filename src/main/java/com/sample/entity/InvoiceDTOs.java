...
private Long id;
    ...
    private List<ProductdetailsDTOs> products;
    private List<InvoicewithouttaxDTOs> invoicewithouttax;
	...
	public List<ProductdetailsDTOs> getProducts() {
		return products;
	}

	public void setProducts(List<ProductdetailsDTOs> products) {
		this.products = products;
	}

	public List<InvoicewithouttaxDTOs> getInvoicewithouttax() {
		return invoicewithouttax;
	}

	public void setInvoicewithouttax(List<InvoicewithouttaxDTOs> invoicewithouttax) {
