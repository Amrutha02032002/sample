...
public class InvoiceRequestDTO {
    ...
    private List<HistoryDetailsDTO> history;
	...
	public List<ProductsDetailsDTO> getProducts() {
		return products;
	}
	public void setProducts(List<ProductsDetailsDTO> products) {
		this.products = products;
	}
	public List<HistoryDetailsDTO> getHistory() {
		return history;
	}
	public void setHistory(List<HistoryDetailsDTO> history) {
