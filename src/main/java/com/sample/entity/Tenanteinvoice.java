...
public class Tenanteinvoice {
	...
	// ✅ One Invoice → Many Payments
	    ...
	    private List<Tenantepayment> payments;
	 ...
	 public List<Tenantepayment> getPayments() {
		 return payments;
	 }

	 public void setPayments(List<Tenantepayment> payments) {
