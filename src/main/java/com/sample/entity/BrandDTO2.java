...
public class BrandDTO2 {
    ...
    // Constructor
    public BrandDTO2(Long id, String name, String brandaddress, String salesrep1title, String salesrep1firstname,
			String salesrep1lastname, String salesrep1mobilenumber, String salesrep1emailid, String salesrep2title,
			String salesrep2firstname, String salesrep2lastname, String salesrep2mobilenumber,
			String salesrep2emailid) {
		super();
		this.id = id;
		this.name = name;
