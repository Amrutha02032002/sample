...
public class EstimateUpdateDTO {
    ...
    private List<EstimateProductDetailUpdateDTO> estimateProductDetails;
    private List<EstimateWithoutTaxUpdateDTO> estimateWithoutTax;
 ...
 // Getters and Setters
	...
	public List<EstimateProductDetailUpdateDTO> getEstimateProductDetails() {
		return estimateProductDetails;
	}


	public void setEstimateProductDetails(List<EstimateProductDetailUpdateDTO> estimateProductDetails) {
		this.estimateProductDetails = estimateProductDetails;
	}


	public List<EstimateWithoutTaxUpdateDTO> getEstimateWithoutTax() {
		return estimateWithoutTax;
	}


	public void setEstimateWithoutTax(List<EstimateWithoutTaxUpdateDTO> estimateWithoutTax) {
