...
public class InvoiceDTO2 {
    ...
    private List<ProductDetailsDTO2> products;
    private List<InvoicewithouttaxDTO2> invoicewithouttax;
 ...
 // Getters and Setters
	...
	public List<ProductDetailsDTO2> getProducts() {
		return products;
	}
	public void setProducts(List<ProductDetailsDTO2> products) {
		this.products = products;
	}
	public List<InvoicewithouttaxDTO2> getInvoicewithouttax() {
		return invoicewithouttax;
	}
	public void setInvoicewithouttax(List<InvoicewithouttaxDTO2> invoicewithouttax) {
